    ...
    >
      <div className="flex flex-col sm:flex-row">
        ...
        <div className="bg-gray-50 p-3 flex flex-row sm:flex-col justify-around items-center gap-3 sm:w-24 border-t sm:border-t-0 sm:border-l border-gray-200">
          <button className="text-primary hover:text-primary/80 p-1.5 rounded-full hover:bg-white transition-colors">
            <i className="ri-information-line text-lg"></i>
          </button>
          <button className="text-gray-500 hover:text-primary p-1.5 rounded-full hover:bg-white transition-colors">
