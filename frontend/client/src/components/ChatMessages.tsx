                ...
                <div className="space-y-4 max-w-[90%]">
                  ...
                  {message.courses && message.courses.length > 0 && (
                    <div className="space-y-3 max-w-[95%]">
                      {message.courses.map((course, courseIndex) => (
                        <CourseCard 
                          key={courseIndex} 
                          course={course} 
                      ...
                      {message.courses.length > 3 && (
                        <button className="w-full text-sm text-primary border border-primary/30 rounded-lg py-2.5 hover:bg-primary/5 transition-colors font-medium shadow-sm">
                          View All {message.courses.length} Matching Courses
                        </button>
                      )}
                    </div>
                  )}
